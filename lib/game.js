(function () {
  ...
  Asteroids.Game = function (dimension) {
    this.lives = 3;
  ...
  Asteroids.Game.prototype.displayStartMessage = function (ctx) {
    ...
    ctx.fillStyle="white";
    ctx.fillText("Asteroids!", this.DIM_X/3, this.DIM_Y/3);
    ctx.fillText("Click to Start", this.DIM_X/3, this.DIM_Y/3 + 35);
    ctx.font="25px Georgia";
    ctx.fillText("Up/Down to move", this.DIM_X/3, this.DIM_Y/3+ 80);
    ctx.fillText("left/right to rotate", this.DIM_X/3, this.DIM_Y/3 + 110);
    ctx.fillText("spacebar to fire", this.DIM_X/3, this.DIM_Y/3 + 140);
  };
