(function () {
  ...
  Asteroids.GameView = function (ctx) {
    ...
    this.game = new Asteroids.Game(dimensions);
    this.ctx = ctx;
  };
  ...
  Asteroids.GameView.prototype.printEndGameMessage = function (message, interval) {
    ...
    var xpos = (this.game.DIM_X/2 + this.game.DIM_X/3)/2;
    this.ctx.fillText(message, xpos, this.game.DIM_Y/3);
    this.ctx.font = "20px Georgia";
    this.ctx.fillText("Click to play again", xpos, this.game.DIM_Y/3 + 30);
    var view = this;
