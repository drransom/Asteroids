(function () {
  ...
  Asteroids.MovingObject = function (args) {
    ...
    if (this.shape === "Circle") {
      ...
      this.satObject = new Astroids.Util.randomPolygon(5, args.pos, args.radius);
    }
    this.vel = args.vel;
  ...
  MovingObject.prototype.drawPolygon = function (ctx) {
    var sides = this.satObject.edges().concat([this.edges()[0]]);
    ctx.beginPath();
  ...
  MovingObject.prototype.movePolygon = function() {
    this.satObject.translate(this.vel);
  };
